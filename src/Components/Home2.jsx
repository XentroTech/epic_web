  ...
  return (
    <div className="min-h-screen">
          ...
          <form onSubmit={handleSearch} className="max-w-3xl mx-auto mb-8">
            <div className="relative">
              <input
                ...
                className="w-full p-6 pr-12 text-gray-900 border-0 rounded-lg text-lg focus:ring-2 focus:ring-green-400"
              />
              <button type="submit" className="absolute right-4 top-1/2 -translate-y-1/2 bg-green-600 text-white rounded-lg px-8 py-3 hover:bg-green-700 transition-colors">
      ...
      <div className='container'>
        <h2 className="category text-3xl text-green-600 font bold pt-12">Categories</h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-7xl">
          <h2 className="text-3xl font-bold mb-8">
            {selectedCategory ? `${selectedCategory} Images` : 'Featured Resources'}
          </h2>
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      <p className="text-white text-sm mb-2 line-clamp-2">{image.description}</p>
                      <button 
      ...
      <section className="py-16 px-4 bg-green-600 text-white">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-green-100 mb-8">Subscribe to our newsletter for new resources and exclusive content.</p>
