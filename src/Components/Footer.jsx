      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h2 className="text-gray-700 text-lg font-bold mb-4">Epic</h2>
            <p className="text-gray-600">Find and download free images for your projects.</p>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-gray-700 font-bold mb-2">Quick Links</h3>
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-gray-700 font-bold mb-2">Follow Us</h3>
        ...
        <div className="border-t border-gray-200 py-4 mt-8 text-center">
          <p className="text-sm text-gray-500">© 2023 Epic. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
